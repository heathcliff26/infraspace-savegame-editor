...
func unlockAllResearch(save *savegame) {
	researchProgress := save.Data()["researchManager"].(map[string]interface{})["researchProgress"].(map[string]interface{})
...
func increaseStarterWorkers(save *savegame, count int) int {
	starterWorkers := save.Data()["market"].(map[string]interface{})["starterWorkers"].([]interface{})
